...
void Run() {
  ...
  if (CMD == "START") {
    ...
    RPMbelakang( SET_RPS, KP, KD);
    // RPMkanan   ( SET_RPS, KP, KD);
...
void RPMbelakang(int rpm, float kp, float kd) {
  float PD, P, D;
  float Error, lError, rateError;
  float setRPM , RPM;
  int PULSE , TS = 1;
...
void RPMkanan(int rpm, float kp, float kd) {
  float PD, P, D;
  float Error, lError, rateError;
  float setRPM , RPM;
  int PULSE , TS = 1;
...
void RPMkiri(int rpm, float kp, float kd) {
  float PD, P, D;
  float Error, lError, rateError;
  float setRPM , RPM;
  int PULSE , TS = 100;
