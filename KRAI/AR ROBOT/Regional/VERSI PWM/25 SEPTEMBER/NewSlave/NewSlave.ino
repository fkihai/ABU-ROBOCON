...
void Bismillah()
{
  ...
  switch (Master.Data) {
    ...
    case 'G':
      ...
      */
      LmprCptType5C(40, 168, 6.0);
      Master.Data = 'H';
      break;

    case 'H':
      LmprCptType4C(40, 168, 6.0);
      Master.Data = 'h';
    case 'h':
      Serial3.print('I');
      Master.Data = 'Z';
