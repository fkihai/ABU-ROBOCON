...
void Bismillah()
{
  ...
  switch (Master.Data) {
    ...
    /*** Type Lempar Gelombang Satu ***/
    case 'A':
      digitalWrite(PW_LPWM_PIN, LOW);
      analogWrite(PW_RPWM_PIN, 0);
      LmprCptType1A(53, 36, 0.78, 0.05);
      Serial3.print('B');
      Master.Data = 'Z';
      break;
    case 'B':
      LmprCptType2A(53, 39, 0.78, 0.05);
      Serial3.print('C');
      Master.Data = 'Z';
      break;
    case 'C':
      LmprCptType3A(53, 39, 0.78, 0.05);
      Serial3.print('D');
      Master.Data = 'Z';
      break;
    case 'D':
      LmprCptType4A(53, 39, 0.78, 0.05);
      Serial3.print('E');
      Master.Data = 'Z';
      break;
    case 'E':
      LmprCptType5A(53, 36, 0.78, 0.05);
      Serial3.print('N');
      Master.Data = 'Z';
      break;

    /*** Type Lempar Gelombang 2 ***/
    case 'F':
      digitalWrite(PW_LPWM_PIN, LOW);
      analogWrite(PW_RPWM_PIN, 0);
      LmprCptType5B(53, 36, 0.78, 0.05);
      Serial3.print('M');
      Master.Data = 'Z';
      break;
    ...
    case 'G':
      digitalWrite(PW_LPWM_PIN, LOW);
      analogWrite(PW_RPWM_PIN, 0);
      LmprCptType5C(53, 23, 0.78, 0.05);
      Serial3.print('H');
      Master.Data = 'Z';
      break;
    case 'H':
      LmprCptType4C(53, 23, 0.78, 0.05);
      Serial3.print('I');
      Master.Data = 'Z';
      break;
    case 'I':
      LmprCptType3C(53, 23, 0.78, 0.05);
      Serial3.print('J');
      Master.Data = 'Z';
      break;
    ...
    case 'K':
      while (true) {
        digitalWrite(PW_LPWM_PIN, LOW);
        analogWrite(PW_RPWM_PIN, 75);
        delay(300);
        digitalWrite(PW_LPWM_PIN, LOW);
        analogWrite(PW_RPWM_PIN, 40);
...
/******* Type A **************/
void LmprCptType1A(float SudutLntr, float RPS, float KP, float KD)
{
  Geser = true;
  Move = true;
  ResetEnc();
...
void LmprCptType2A(float SudutLntr, int RPS, float KP, float KD)
{
  Geser = true;
  Move = true;
  ResetEnc();
...
void LmprCptType3A(float SudutLntr, int RPS, float KP, float KD)
{
  pwm = 50;
  Geser = true;
  Move = true;
...
void LmprCptType4A(float SudutLntr, int RPS, float KP, float KD)
{
  pwm = 50;
  Geser = true;
  Move = true;
...
void LmprCptType5A(float SudutLntr, int RPS, float KP, float KD)
{
  Move = true;
  Putar = true;
  ResetEnc();
...
/******* Type C **************/
void LmprCptType5C(float SudutLntr, int RPS, float KP, float KD) {
  Move = true;
  Putar = true;
  ResetEnc();
  while (Move) {
...
void LmprCptType4C(float SudutLntr, int RPS, float KP, float KD) {
  Geser = true;
  Move = true;
  pwm = 50;
  ResetEnc();
  while (Move)
  {
    while (Geser)
    {
      ...
      digitalWrite(SP_LPWM_PIN, LOW);
      digitalWrite(doorlock1, HIGH);
      if (abs(EncSliderPutar.Angle) > 75) {
        digitalWrite(doorlock1, LOW);
    ...
    while (Persiapan) {
      ...
      analogWrite(SP_LPWM_PIN, 200);
      digitalWrite(SP_RPWM_PIN, LOW);
      if (digitalRead(SwtchGeser) == LOW && abs(Distance) > 10) {
        Sensor = true;
      } if (Sensor) {
        pwm = 0;
        analogWrite(SG_RPWM_PIN, LOW);
...
void LmprCptType3C(float SudutLntr, int RPS, float KP, float KD) {
  Geser = true;
  Move = true;
  pwm = 50;
  ResetEnc();
  while (Move)
  {
    while (Geser)
    {
      ...
      digitalWrite(SP_LPWM_PIN, LOW);
      digitalWrite(doorlock1, HIGH);
      SoftSpeed(28, 20, abs(Distance), 38);
      if (digitalRead(SwtchGeser) == LOW && abs(Distance) > 10) {
        Sensor = true;
      } if (Sensor) {
        pwm = 0;
        ...
        digitalWrite(PW_LPWM_PIN, LOW);
        analogWrite(PW_RPWM_PIN, LOW);
      } if (abs(EncSliderPutar.Angle) > 80) {
        digitalWrite(doorlock1, LOW);
        Revers = true;
      } if (Revers) {
...
void trialThrowing()
{
  ...
  {
    LmprCptType5B(48.0, 64, 0.38, 0.05);
    Ctrlthrow = 'Z';
    Coba = false;
  }
  switch (Ctrlthrow)
  {
    case 'A':
      ...
      break;
    case 'B':
      LmprCptType3C(48.0, 64, 0.38, 0.05);
      Ctrlthrow = 'Z';
      break;
    case 'C':
      LmprCptType4A(48.0, 36, 0.38, 0.05);
      Ctrlthrow = 'D';
      break;
    case 'D':
      LmprCptType5A(48.0, 36, 0.38, 0.05);
      Ctrlthrow = 'Z';
    default:
      break;
  }
...
void RPSpelontar(float RPS, float kp, float kd)
{
  float
  Kp = kp,
  Kd = kd, TS = 1;
