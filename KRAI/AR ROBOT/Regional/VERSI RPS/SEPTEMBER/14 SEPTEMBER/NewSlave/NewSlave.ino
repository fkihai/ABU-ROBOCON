...
void Bismillah()
{
  ...
  switch (Master.Data) {
    ...
    case 'G':
      LmprCptType5C(27, 150 , 0.72, 0.05);
      Master.Data = 'H';
      break;

    case 'H':
      LmprCptType4C(27 , 150, 0.72, 0.05);
      Master.Data = 'h';
    case 'h':
      Serial3.print('I');
      Master.Data = 'Z';
    ...
    case 'I':
      LmprCptType3C(29, 150, 0.72, 0.05);
      Master.Data = 'i';
    case 'i':
      Serial3.print('J');
      Master.Data = 'Z';
