...
void Bismillah()
{
  ...
  switch (Master.Data) {
    ...
    case 'A':
      ...
      LmprCptType1A(48, 178, 0.48, 0.07);
      Serial3.print('B');
      Master.Data = 'Z';
      break;
    case 'B':
      LmprCptType2A(48, 178, 0.48, 0.07);
      Serial3.print('C');
      Master.Data = 'Z';
      break;
    case 'C':
      LmprCptType3A(48, 178, 0.48, 0.07);
      Serial3.print('D');
      Master.Data = 'Z';
      break;
    ...
    case 'D':
      LmprCptType4A(50, 390, 0.48, 0.07);
      Serial3.print('E');
      Master.Data = 'Z';
      break;
    case 'E':
      LmprCptType5A(50, 395, 0.48, 0.07);
      Serial3.print('N');
      Master.Data = 'Z';
      break;
    ...
    case 'F':
      digitalWrite(PW_LPWM_PIN, LOW);
      analogWrite(PW_RPWM_PIN, 0);
      LmprCptType5B(50, 395, 0.48, 0.07);
      Serial3.print('M');
      Master.Data = 'Z';
      break;
    ...
    case 'G':
      digitalWrite(PW_LPWM_PIN, LOW);
      analogWrite(PW_RPWM_PIN, 0);
      LmprCptType5C(33, 149, 0.72, 0.05);
      Master.Data = 'H';
      break;
    case 'H':
      LmprCptType4C(33, 149, 0.72, 0.05);
      Serial3.print('I');
      Master.Data = 'Z';
      break;
    case 'I':
      LmprCptType3C(33, 149, 0.72, 0.05);
      Serial3.print('J');
      Master.Data = 'Z';
      break;
...
void LmprCptType3C(float SudutLntr, int RPS, float KP, float KD) {
  ...
  while (Move)
  {
    ...
    while (Geser)
    {
      ...
      analogWrite(SG_LPWM_PIN, pwm);
      digitalWrite(SG_RPWM_PIN, LOW);
      SoftSpeed(18, 20, abs(Distance), 28);
