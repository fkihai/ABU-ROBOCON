...
void Bismillah()
{
  ...
  switch (Master.Data) {
    ...
    case 'A':
      ...
      LmprCptType1B(53, 32, 0.78, 0.05);
      CapitStop();
      Serial3.print('B');
      Master.Data = 'Z';
      break;
    case 'B':
      LmprCptType2B(53, 32, 0.78, 0.05);
      CapitStop();
      Serial3.print('C');
      Master.Data = 'Z';
      break;
    case 'C':
      LmprCptType3B(53, 32, 0.78, 0.05);
      CapitStop();
      Serial3.print('D');
      Master.Data = 'Z';
      break;
    case 'D':
      LmprCptType4B(54, 38, 0.78, 0.05);
      CapitStop();
      Master.Data = 'E';
      break;
    case 'E':
      LmprCptType5B(55, 41, 0.78, 0.05);
      CapitStop();
      Serial3.print('N');
      Master.Data = 'Z';
      break;
    ...
    case 'F':
      digitalWrite(PW_LPWM_PIN, LOW);
      analogWrite(PW_RPWM_PIN, 0);
      LmprCptType5A(49,44,0.32,0.03);
      // Serial3.print('E');
      Master.Data = 'G';
      break;
    case 'G':
      LmprCptType4A(48,44,0.32,0.03);
      Serial3.print('F');
      Master.Data = 'Z';
      break;
    case 'H':
      LmprCptType3A(48,44,0.32,0.03);
      Serial3.print('G');
      Master.Data = 'Z';
      break;
    case 'I':
      LmprCptType2A(48,44,0.32,0.03);
      CapitStop();
      Serial3.print('H');
      Master.Data = 'Z';
      break;
    case 'J':
      LmprCptType1A(48,45,0.32,0.03);
      CapitStop();
      Master.Data = 'Z';
      Serial3.print('W');
      break;
