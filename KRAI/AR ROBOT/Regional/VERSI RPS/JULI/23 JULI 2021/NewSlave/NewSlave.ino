...
void ThrowZone1()
{
  switch (Master.Data) {
    ...
    case 'A':
      ...
      LmprCptType1B(50, 57, 0.39, 0.05);
      CapitStop();
      Serial3.print('B');
      Master.Data = 'Z';
      break;
    case 'B':
      LmprCptType2B(50, 56, 0.38, 0.05);
      CapitStop();
      Serial3.print('C');
      Master.Data = 'Z';
      break;
    case 'C':
      LmprCptType3B(50, 58, 0.4, 0.05);
      CapitStop();
      Serial3.print('D');
      Master.Data = 'Z';
      break;
    case 'D':
      LmprCptType4B(50, 60, 0.4, 0.05);
      CapitStop();
      Master.Data = 'E';
      break;
    case 'E':
      LmprCptType5B(50, 60, 0.4, 0.05);
      CapitStop();
      Master.Data = 'Z';
      break;
...
void LmprCptType5B(float SudutLntr, int RPS, float KP, float KD)
{
  ...
  while (Move)
  {
    while (Geser)
    {
      ...
      digitalWrite(SG_LPWM_PIN, LOW);
      while (EncSliderPutar.Angle > 40.0)
      {
