/*
  ...
  a,50,65,0.58,0.05 (Capit 3)
  a,50,65,0.58,0.05 (Capit 4 da 5)
  a,50,65,0.48,0.05
...
void ThrowZone1()
{
  switch (Master.Data) {
    ...
    case 'A':
      ...
      LmprCptType1B(45, 60, 0.38, 0.05);
      CapitStop();
      Serial3.print('B');
      Master.Data = 'Z';
      break;
    case 'B':
      LmprCptType2B(45, 60, 0.38, 0.05);
      CapitStop();
      Serial3.print('C');
      Master.Data = 'Z';
      break;
    case 'C':
      LmprCptType3B(50, 60, 0.39, 0.05);
      CapitStop();
      Serial3.print('D');
      Master.Data = 'Z';
      break;
...
void LmprCptType5B(float SudutLntr, int RPS, float KP, float KD)
{
  ...
  while (Move)
  {
    while (Geser)
    {
      ...
      digitalWrite(SG_LPWM_PIN, LOW);
      while (EncSliderPutar.Angle > 22.8)
      {
        analogWrite(SP_LPWM_PIN, LOW);
        digitalWrite(SP_RPWM_PIN, LOW);
        analogWrite(SG_RPWM_PIN, LOW);
