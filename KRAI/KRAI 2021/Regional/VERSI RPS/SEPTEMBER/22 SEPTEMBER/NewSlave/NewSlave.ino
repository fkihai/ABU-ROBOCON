...
void Bismillah()
{
  ...
  switch (Master.Data) {
    ...
    case 'B':
      LmprCptType2A(50, 102, 0.55, 0.05);
      Master.Data = 'b';
      break;
    case 'b':
      Serial3.print('C');
      ...
      break;  
    case 'C':
      LmprCptType3A(50, 102, 0.55, 0.05);
      Master.Data = 'c';
      break;
    case 'c':
      Serial3.print('D');
    ...
    case 'D':
      LmprCptType4A(52, 102, 0.78, 0.02);
      Master.Data = 'd';
      break;
    case 'd':
      Serial3.print('E');
    ...
    case 'E':
      LmprCptType5A(52, 102, 0.78, 0.02);
      Master.Data = 'e';
      break;
    case 'e':
      Serial3.print('N');
    ...
    case 'F':
      LmprCptType5B(54, 105, 0.78, 0.02);
      Master.Data = 'f';
      break;
    case 'f':
      Serial3.print('M');
    ...
    case 'G':
      LmprCptType5C(44, 37, 0.33, 0.05);
      Master.Data = 'H';
      break;

    case 'H':
      LmprCptType4C(44 , 35, 0.33, 0.05);
      Master.Data = 'h';
    case 'h':
      Serial3.print('I');
      Master.Data = 'Z';
